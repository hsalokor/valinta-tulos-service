...
class ProductionSmokeTest extends Specification {
  ...
  "tuotantoympäristön valintatuloksissa " should {
    ...
    "hakija hakemuksella " + varalla + " on varasijalla ylemmässä hakutoiveessa ja alempi on kesken" in {
      ...
      resultString must_== "{\"hakemusOid\":\"1.2.246.562.11.00000887126\",\"aikataulu\":{},\"hakutoiveet\":[{\"hakukohdeOid\":\"1.2.246.562.14.2014040212501070122979\",\"tarjoajaOid\":\"1.2.246.562.10.87157719573\",\"valintatila\":\"VARALLA\",\"vastaanottotila\":\"KESKEN\",\"ilmoittautumistila\":\"EI_TEHTY\",\"vastaanotettavuustila\":\"EI_VASTAANOTETTAVISSA\",\"viimeisinVastaanottotilanMuutos\":\"2014-09-25T11:03:07Z\",\"jonosija\":32,\"varasijanumero\":1,\"julkaistavissa\":true},{\"hakukohdeOid\":\"1.2.246.562.14.2014032014424092013626\",\"tarjoajaOid\":\"1.2.246.562.10.16538823663\",\"valintatila\":\"KESKEN\",\"vastaanottotila\":\"KESKEN\",\"ilmoittautumistila\":\"EI_TEHTY\",\"vastaanotettavuustila\":\"EI_VASTAANOTETTAVISSA\",\"julkaistavissa\":false}]}"
    }
  }
}
