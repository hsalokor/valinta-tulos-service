...
class HakemusRepositorySpec extends ITSpecification {
  ...
  "HakemusRepository" should {
    "palauttaa yksittäisen Hakemuksen" in {
      ...
      hakutoiveet must_== Some(Hakemus("1.2.246.562.11.00000878229", "1.2.246.562.24.14229104472",
    ...
    "palauttaa kaikki Hakuun liittyvät Hakemukset" in {
      ...
      hakemukset must_== Seq(Hakemus("1.2.246.562.11.00000441369", "1.2.246.562.24.14229104472",
