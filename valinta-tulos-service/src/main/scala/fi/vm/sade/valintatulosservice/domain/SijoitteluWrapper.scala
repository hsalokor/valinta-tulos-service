...
case class SijoitteluajonValintatapajonoWrapper(oid:String, nimi:String, prioriteetti:Int, aloituspaikat:Int, alkuperaisetAloituspaikat:Option[Int],
                                                eiVarasijatayttoa:Boolean, kaikkiEhdonTayttavatHyvaksytaan:Boolean, poissaOlevaTaytto:Boolean,
                                                varasijat:Int = 0, varasijaTayttoPaivat:Int = 0,
                                                varasijojaKaytetaanAlkaen:Option[Date], varasijojaTaytetaanAsti:Option[Date],
                                                hyvaksytty:Option[Int], varalla:Option[Int], alinHyvaksyttyPistemaara:Option[BigDecimal],
