 ...
 * @param hakuOid
 */
case class SimpleGeneratedHakuFixture(hakukohteita: Int, hakemuksia: Int, override val hakuOid: String = "1", hakemuksenTilat: List[HakemuksenTila] = Nil) extends GeneratedHakuFixture(hakuOid) {
